...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo e(URL::to('instituto')); ?>"><i class='fa fa-link'></i> <span>Institutos</span></a></li>
             <li><a href="<?php echo e(URL::to('espacio')); ?>"><i class='fa fa-link'></i> <span>Espacios</span></a></li>
            <li class="treeview">
